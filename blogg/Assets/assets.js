...
export const assets = {
    ...
    export const blog_data = [{
        ...
        description:"This UNESCO World Heritage Site is an ancient rock fortress and palace ruin. Rising majestically from the central plains, it features stunning frescoes, well-preserved gardens, and the remnants of an extensive network of moats and water gardens.",
        image:blog_pic_1,
        date:Date.now(),
